...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num +923485285024✓')
	    psb('WellCome To Saadat_BALOCH')
	    psb('Congratulations Saadat_BALOCH Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ saadatbaloch3399✓')
	    psb('🔓Password ☆ saadat11✓')
	    psb('Find my Facebook id ✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Saadat_BALOCH && python2 B4.py')
	elif bm =='3':
	    os.system('xdg-open Facebook )
	    menu()
	elif bm =='4':
